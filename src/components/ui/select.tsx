...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value
      ref={ref}
      className={cn(
        'text-content-tertiary  line-clamp-1 flex flex-row items-center gap-2 text-body',
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'border-none dark:active:bg-input/50 bg-fill-tertiary flex h-10 native:h-16 flex-row items-center justify-between gap-2 rounded-md px-3 py-2  ',
          ...
          <TextClassContext.Provider value="text-popover-foreground">
            <NativeOnlyAnimatedView className="z-50" entering={FadeIn} exiting={FadeOut}>
              <SelectPrimitive.Content
                className={cn(
                  'bg-fill-primary border-none relative z-50 w-fit rounded-md',
                  'mt-1',
                  'shadow-[0_0_3px_0_var(--border-tertiary,#8E8E8E)]',
                  Platform.select({
                    web: cn(
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.ItemText className="text-content-primary group-active:text-accent-foreground select-none text-body" />
    </SelectPrimitive.Item>
  )
}
