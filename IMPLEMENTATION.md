...
src/
  app/                          # Expo Router (file-based routing)
    ...
    (onboarding)/               # First-time user flow (splash, greeting, welcome, manifesto)
...
| Welcome screen | `src/app/(onboarding)/welcome.tsx` | Avatar, useOnboardingStore |
...
| Modal bottom sheet | `src/components/ui/Modal.tsx` | - |
...
All current deps are sufficient for P0.
...
# react-native-reanimated already needed from P1
```
...
### Components to Create (see `src/components/ui/TODO.md`)
- [ ] Header
- [ ] Divider
- [ ] Avatar
- [ ] StatCard
...
### Hooks/Stores to Create (see `src/hooks/index.ts` TODO)
- [ ] useAuthStore
- [ ] useProfileStore
- [ ] useOnboardingStore
- [ ] useNetworkStatus
